...
figure(1);
plot(r_scl(2:Nf), fuel_rad_stress_1(2:Nf)*1e-9,'color','k','linewidth',3);
hold on
plot(r_scl(2:Nf), fuel_rad_stress_2(2:Nf)*1e-9,'color','r','linewidth',3);
plot(r_scl(2:Nf), fuel_rad_stress_3(2:Nf)*1e-9,'color','g','linewidth',3);
hold off
...
figure(2);
plot(r_scl(Nf + Nc:N), clad_rad_stress_1(2:end)*1e-9,'color','k','linewidth',3);
hold on
plot(r_scl(Nf + Nc:N), clad_rad_stress_2(2:end)*1e-9,'color','r','linewidth',3);
plot(r_scl(Nf + Nc:N), clad_rad_stress_3(2:end)*1e-9,'color','g','linewidth',3);
hold off
...
figure(3);
plot(r_scl(2:Nf), fuel_hoop_stress_1(2:Nf)*1e-9,'color','k','linewidth',3);
hold on
plot(r_scl(2:Nf), fuel_hoop_stress_2(2:Nf)*1e-9,'color','r','linewidth',3);
plot(r_scl(2:Nf), fuel_hoop_stress_3(2:Nf)*1e-9,'color','g','linewidth',3);
hold off
...
figure(4);
plot(r_scl(Nf + Nc:N), clad_hoop_stress_1(2:end)*1e-9,'color','k','linewidth',3);
hold on
plot(r_scl(Nf + Nc:N), clad_hoop_stress_2(2:end)*1e-9,'color','r','linewidth',3);
plot(r_scl(Nf + Nc:N), clad_hoop_stress_3(2:end)*1e-9,'color','g','linewidth',3);
hold off
...
saveas(figure(1),'Fuel_Radial_Stress');
saveas(figure(2),'Clad_Radial_Stress');
saveas(figure(3),'Fuel_Hoop_Stress');
saveas(figure(4),'Clad_Hoop_Stress');
saveas(figure(5),'Temp_Plot');